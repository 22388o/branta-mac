...
class Verify: Automation {
    ...
    // On MacBook Air, CPU spike to like 85 when I have Blockstream here.
    static let VERIFY_INTERVAL = 5.0
    ...
    static let x86_HASHES = [
        // Note - Blockstream looks like X86 only.
        // There is one unix binary and it it 200MB. Takes time to hash.
        [ BLOCKSTREAM_GREEN:
            [
            ...
            "1.2.4": "66d6c4d677d2295035fd2f0e5ea38d4f04d1f6b71a8930520d3417c88111947f" // July 17th, 2023
        ]
        ],
        [ SPARROW:
         [
            ...
            "1.5.5":"d1d3caaf73368ca31ff1d15fd40e5439fd9dc2c7c95ab69d46f6e49e92d4e151" // 12/16/2021
         ]
        ],
        [ TREZOR:
            [
                ...
                "23.1.1": "516f165b72c0b0fb673a51500036e0d18de6fdab5c9f2734c954c58a8d5aa9a9", // End 2023
            ]
          ],
        // Ledger bundles both into a universal binary.... so lets just copy my x86 hash into arm
        // and it should work.
...
//        print("signatures: \(signatures)")
    ...
    static func matchSignatures(wallets: Array<[String: String]>) -> Array<[String: String]> {
        ...
        // TODO - left off here. Exit on the below loops if this kicks over to false.
    ...
    static func sha256(at filePath: String) -> String {
        do {
            ...
            // TODO - need handling around this
